...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.navDecisionTreeButton).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_decisionTreeFragment)
        }

        view.findViewById<Button>(R.id.navQuizButton).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_quizFragment)
        }

        view.findViewById<Button>(R.id.navBarcodeButton).setOnClickListener {
